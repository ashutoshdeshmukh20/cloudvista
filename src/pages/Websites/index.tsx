        ...
        Cell: (cellProps: any) => {
          ...
          return (
            <UncontrolledDropdown>
              ...
              >
                <DropdownItem
                  onClick={(event) => handleView(cellProps.row.original.id)}
                >
                  <i
                ...
                <DropdownItem>
                  <i
                    className="mdi mdi-close-thick font-size-18 text-success me-1"
                    id="canceltooltip"
                  ></i>{" "}
                  Cancel
                ...
                >
                  <i
                    className="mdi mdi-trash-can font-size-16 text-danger me-2"
                    id="deletetooltip"
                  ></i>
                  Delete
                ...
                <DropdownItem>
                  <i
                    className="mdi mdi-account-convert font-size-18 text-success me-1"
                    id="renewtooltip"
                  ></i>{" "}
                  Renew
                  <UncontrolledTooltip placement="top" target="renewtooltip">
                    {" "}
                    Renew{" "}
                  </UncontrolledTooltip>
                </DropdownItem>
